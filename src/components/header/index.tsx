  ...
  return (
    <header className={className + " " + navbarTypeClass()}>
      <div
        ...
        ${borderSwicthClass()}
             ${
               menuType === "horizontal" && parseInt(width.toString()) > parseInt(breakpoints.xl.toString())
                 ? "py-1"
                 : "md:py-6 py-3"
             }
        `}
        ...
        <div className="flex justify-between items-center h-full">
          ...
          {menuType === "vertical" && (
            <div className="flex items-center md:space-x-4 space-x-2 rtl:space-x-reverse">
              {collapsed && width >= parseInt(breakpoints.xl.toString()) && (
                <button
              ...
              {width < parseInt(breakpoints.xl) && <Logo />}
              {/* open mobile menu handlaer*/}
              {width < parseInt(breakpoints.xl) && width >= parseInt(breakpoints.md) && (
                <div
          ...
          {menuType === "horizontal" && width >= parseInt(breakpoints.xl) ? (
            <HorizentalMenu />
          ) : null}
          {/* Nav Tools  */}
          <div className="nav-tools flex items-center lg:space-x-6 space-x-3 rtl:space-x-reverse">
            ...
            {width >= parseInt(breakpoints.md) && <Notification />}
            {width >= parseInt(breakpoints.md) && <Profile />}
